...
实验截图： ![1](./screenshot/LabWeek02_1.png)
...
编译报错（未解决）： ![3](./screenshot/LabWeek02_3.png)
...
测试结果：![5](./screenshot/LabWeek02_5.png)
...
测试结果：![6](./screenshot/LabWeek02_6.png)
...
测试结果：![7](./screenshot/LabWeek02_7.png)
...
测试结果：![7](./screenshot/LabWeek02_20.png)
...
测试结果：![19](./screenshot/LabWeek02_19.png)
...
测试结果：![13](./screenshot/LabWeek02_13.png)
...
测试结果：![14](./screenshot/LabWeek02_14.png)
...
测试结果：![15](./screenshot/LabWeek02_15.png)
...
测试结果：![16](./screenshot/LabWeek02_16.png)
...
测试结果：![17](./screenshot/LabWeek02_17.png)

测试结果：![18](./screenshot/LabWeek02_18.png)
...
编译报错： ![4](./screenshot/LabWeek02_2.png)

**解决方案**：对程序部分进行了修改(即采用了问题1的解决方案1)，并找到动态库 /lib64/ld-linux-x86-64.so.2

正确运行：![5](./screenshot/LabWeek02_4.png)
   
参考：https://blog.csdn.net/FreeeLinux/article/details/85147455

**未解决**：不清楚报错原因。

编译报错： ![6](./screenshot/LabWeek02_3.png)

## 问题3：程序 movtest3 异常

异常运行：![8](./screenshot/LabWeek02_8.png)
...
正确结果：![20](./screenshot/LabWeek02_20.png)

## 问题4： 程序 movtest4 单步调试异常

异常运行：![9](./screenshot/LabWeek02_9.png)
...
正常运行：![10](./screenshot/LabWeek02_10.png)
...
异常结果：![12](./screenshot/LabWeek02_12.png)
...
正确结果：![19](./screenshot/LabWeek02_19.png)
