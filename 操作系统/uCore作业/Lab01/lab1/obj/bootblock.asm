...
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    ...
    7c87:	c1 ee 09             	shr    $0x9,%esi
readseg(uintptr_t va, uint32_t count, uint32_t offset) {
    7c8a:	53                   	push   %ebx
    va -= offset % SECTSIZE;
    7c8b:	89 c3                	mov    %eax,%ebx
    uintptr_t end_va = va + count;
    7c8d:	89 7d f0             	mov    %edi,-0x10(%ebp)
    ...
    7c94:	73 70                	jae    7d06 <readseg+0x94>
...
outb(uint16_t port, uint8_t data) {
    ...
    7d04:	eb 8a                	jmp    7c90 <readseg+0x1e>
...
bootmain(void) {
    ...
    7d11:	31 c9                	xor    %ecx,%ecx
    7d13:	ba 00 10 00 00       	mov    $0x1000,%edx
...
bootmain(void) {
    ...
    7d20:	53                   	push   %ebx
    readseg((uintptr_t)ELFHDR, SECTSIZE * 8, 0);
    7d21:	e8 4c ff ff ff       	call   7c72 <readseg>

    // is this a valid ELF?
    if (ELFHDR->e_magic != ELF_MAGIC) {
    7d26:	81 3d 00 00 01 00 7f 	cmpl   $0x464c457f,0x10000
    7d2d:	45 4c 46 
    7d30:	75 3f                	jne    7d71 <bootmain+0x65>
    }
    ...
    7d63:	eb e4                	jmp    7d49 <bootmain+0x3d>
    }

    // call the entry point from the ELF header
    // note: does not return
    ((void (*)(void))(ELFHDR->e_entry & 0xFFFFFF))();
    7d65:	a1 18 00 01 00       	mov    0x10018,%eax
    7d6a:	25 ff ff ff 00       	and    $0xffffff,%eax
    7d6f:	ff d0                	call   *%eax
}
...
outw(uint16_t port, uint16_t data) {
    ...
    7d71:	ba 00 8a ff ff       	mov    $0xffff8a00,%edx
    7d76:	89 d0                	mov    %edx,%eax
    7d78:	66 ef                	out    %ax,(%dx)
    7d7a:	b8 00 8e ff ff       	mov    $0xffff8e00,%eax
    7d7f:	66 ef                	out    %ax,(%dx)
    7d81:	eb fe                	jmp    7d81 <bootmain+0x75>
